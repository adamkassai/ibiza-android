...
public class MoviePagerFragment extends Fragment {
    ...
    private class DownloadData extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("http://kassaiweb.com/movies.json")
                        .build();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result!=null) {
                movies = gson.fromJson(result, new TypeToken<ArrayList<Movie>>(){}.getType());

                mSectionsPagerAdapter = new SectionsPagerAdapter(getChildFragmentManager());
                mViewPager = (ViewPager) getView().findViewById(R.id.container);
                mViewPager.setAdapter(mSectionsPagerAdapter);
                Log.d("CURRENT", Integer.toString(mViewPager.getCurrentItem()));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putString("movieJson", gson.toJson(movies.get(position)));
            f.setArguments(args);
            return f;
        }
